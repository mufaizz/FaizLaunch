export const mockAPI = {
  ...
  doctorScan: async () => ([
    ...
    },
    {
      ...
      category: 'storage',
      title: 'HDD Detected',
      description: 'You are using a Hard Disk Drive. Installs will take 8-15 hours.',
      fix: 'FaizLaunch checkpoint system protects your installs. Do not interrupt.',
      autoFixable: false,
    },
    {
      id: 'low_pagefile',
    ...
    },
    {
      ...
      description: '2 paused or failed installations that can be resumed.',
      fix: 'Go to Install tab to resume, or clear them.',
      autoFixable: true,
    },
  ]),
  doctorAutofix: async (id: string) => ({ success: true, message: 'Fixed successfully' }),
